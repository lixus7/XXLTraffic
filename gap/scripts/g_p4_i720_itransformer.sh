...
CUDA_VISIBLE_DEVICES=0 python -u run.py \
  ...
  --learning_rate 0.001 \
  --des 'Exp' \
  --itr 1   >> itransformer_pems04_gap_in720_out96_srate01_trseed2024.log 2>&1 & \
...
CUDA_VISIBLE_DEVICES=1 python -u run.py \
  ...
  --learning_rate 0.001 \
  --des 'Exp' \
  --itr 1  >> itransformer_pems04_gap_in720_out192_srate01_trseed2024.log 2>&1 & \
...
CUDA_VISIBLE_DEVICES=2 python -u run.py \
  ...
  --learning_rate 0.001 \
  --des 'Exp' \
  --itr 1 >> itransformer_pems04_gap_in720_out336_srate01_trseed2024.log 2>&1 & \
...
CUDA_VISIBLE_DEVICES=3 python -u run.py \
  ...
  --learning_rate 0.001 \
  --des 'Exp' \
  --itr 1 >> itransformer_pems04_gap_in720_out720_srate01_trseed2024.log 2>&1
