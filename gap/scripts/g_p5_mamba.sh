...
CUDA_VISIBLE_DEVICES=0 python -u run.py \
  ...
  --d_conv 4 \
  --des 'Exp' \
  --itr 1   >> mamba_pems05_gap_in96_out96_srate01_trseed2024.log 2>&1 & \
...
CUDA_VISIBLE_DEVICES=1 python -u run.py \
  ...
  --d_conv 4 \
  --des 'Exp' \
  --itr 1  >> mamba_pems05_gap_in96_out192_srate01_trseed2024.log 2>&1 & \
...
CUDA_VISIBLE_DEVICES=2 python -u run.py \
  ...
  --d_conv 4 \
  --des 'Exp' \
  --itr 1 >> mamba_pems05_gap_in96_out336_srate01_trseed2024.log 2>&1
...
# CUDA_VISIBLE_DEVICES=3 python -u run.py \
  ...
  # --d_conv 4 \
  # --des 'Exp' \
  # --itr 1 >> mamba_pems05_gap_in96_out720_srate01_trseed2024.log 2>&1
