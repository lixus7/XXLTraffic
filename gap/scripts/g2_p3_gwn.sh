...
python -u run.py \
  ...
  --train_epoch 200 \
  --patience 5 \
  --lradj 'type3' >> gwn_pems03_gap2_in96_out96_srate01_trseed2024.log 2>&1
...
python -u run.py \
  ...
  --train_epoch 200 \
  --patience 5 \
  --lradj 'type3'  >> gwn_pems03_gap2_in96_out192_srate01_trseed2024.log 2>&1
...
python -u run.py \
  ...
  --train_epoch 200 \
  --patience 5 \
  --lradj 'type3'  >> gwn_pems03_gap2_in96_out336_srate01_trseed2024.log 2>&1
